...
<p style="font-size:14px; font-weight:bold; text-align:justify;"> Noyon Lanka is proud of its record in delivering top-class products, always managing to maintain a rating of 100% for quality. Every process is serious, down to the last detail, to make sure that the items produced answer the very stringent quality criteria set by the company. Noyon Lanka ascertains high quality through rigid control methods and by seeking improvement at all times to make sure that their products meet or even surpass customer expectations, thus making them one of the industry leaders.</p>
</div>
</div>
</section>
...
<div class="box-container">
    ...
    <div class="row">
        ...
        $sql = "SELECT img1, desc1, img2, desc2, img3, desc3 FROM addpic_table WHERE emp_id=003";
...
<section class="contact">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>email address</h3>
         <a href="noyon@gmail.com">noyon@gmail.com</a>
         <a href="noyon.lanka@gmail.com">noyon.lanka@gmail.com</a>
      </div>
